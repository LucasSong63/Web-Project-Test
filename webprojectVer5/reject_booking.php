...
<meta charset="UTF-8">
    ...
    <title>Rejecting Space Booking Application</title>
    <style>
        .container {
...
<header class="header"> <!--For the upper side bar-->
 ...
 <section class="container">
    <h1>REJECT BOOKING APPLICATION</h1>
    ...
    <form name="update_status" method="post" action="update_booking_status.php">
    <div class="table">
    <table style="max-width:85%">        
        ...
        <tr>
            ...
            <td><input type="text" disabled id="status" value="Rejected" size="10"></td>
            <td><button type="submit">Confirm</td>
        </tr>
    </table>
    </div>
      <?php 
     } else {
        echo "<p>There are no records to show</p>";
    }
    mysqli_close($conn);
?>
</form>
